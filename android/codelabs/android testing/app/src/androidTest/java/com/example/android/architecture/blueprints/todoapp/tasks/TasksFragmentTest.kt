...
class TasksFragmentTest {
    ...
    fun clickTask_navigateToDetailFragmentOne() = runBlockingTest {
        repository.saveTask(Task("Title1", "Description 1", false, "id1"))
        repository.saveTask(Task("Title2", "Description 2", true, "id2"))
    ...
    fun clickAddTaskButton_navigateToAddEditFragment() = runBlockingTest {
        val scenario =
            launchFragmentInContainer<TasksFragment>(themeResId = R.style.AppTheme)
        val navController = mock(NavController::class.java)
        scenario.onFragment {
            Navigation.setViewNavController(it.view!!, navController)
        }
